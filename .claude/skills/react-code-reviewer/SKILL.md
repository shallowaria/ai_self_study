...
description: A specialized skill for reviewing React code based on the project's constitution. Use this skill whenever a user asks to review Go code, check for best practices, or analyze code quality in this repository.
---
...
model: opus
allowed-tools: Read, Glob, Bash(pnpm tsc:_), Bash(pnpm lint:_)
...
本技能专用于根据本项目的开发“宪法” (`constitution.md`)，对React语言代码进行深入、专业的审查。
